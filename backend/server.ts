  ...
  app.post('/api/sync', async (req, res) => {
    ...
    if (isPgConnected) {
      ...
      try {
        ...
        // Seeding primary if empty - REMOVED SEEDING TO START FROM AN ABSOLUTELY CLEAN EMPTY WORKSPACE AS REQUESTED BY USER
    ...
    if (!isPgConnected) {
      ...
      // Ensure users have seeded tasks if they have none - REMOVED SEEDING TO START CLEAN
